rules = [
    ...
    {"name": "R20_mediumrisk_combination", "condition": lambda f: (f.get("payment_behavior") == "average" or f.get("debt_risk") == "medium") and f.get("overall_risk") != "high", "conclusion": ("overall_risk", "medium")},
    {"name": "R21_lowrisk_combination", "condition": lambda f: f.get("payment_behavior") == "excellent" and f.get("debt_risk") == "low" and f.get("financial_capacity") in ("strong", "stable") and f.get("overall_risk") not in ("high", "medium"), "conclusion": ("overall_risk", "low")},
